    ...
    return (
        <ImageBackground source={imagePath.cardBg} style={[styles.contaner, themeCardColor]}>
            ...
            <View style={styles.cardTextContainer}>
                <Text style={[styles.titleText, themeTextColor]}>dfhgjhf</Text>
                <View style={{ width: '100%', paddingBottom: 10, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: colorCode.gold, fontWeight: '600', marginLeft: 5 }}>Shakib Al hasan</Text>
                </View>
                    ...
                    <>
                        {!callJoin ?
                            ...
                            <View style={{ marginLeft: 60 }}>
                                ...
                                <TouchableOpacity style={{ backgroundColor: colorCode.gold, height: 50, width: 50, borderRadius: 50, justifyContent: 'center', alignItems: 'center' }}>
