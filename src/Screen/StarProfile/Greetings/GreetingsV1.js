...
const GreetingsV1 = ({ setProfileNavigate, star_id }) => {
  ...
  const { themeBacground, themeTextColor, themeCardColor } = useThemeColor();
  ...
  console.log('greeting-------------', GreetingInfo?.video);
  return (
    <>
      <AlertModal
        modalObj={modalObj}
                ...
                <View style={[styles.greetingsRequest, themeCardColor]}>
                  ...
                  <View style={{ margin: 13 }}>
                    {GreetingInfo.video != null ? (
                      <CustomVideoPlayerV1
                        // videoUrl={
                        //   'https://shahadot-tfp-hellosuperstars.s3.ap-southeast-1.amazonaws.com/video/1680675534927.mp4'
                        // }
                        videoUrl={AppUrl.videoCdn + GreetingInfo.video}
                        thumbnail={GreetingInfo?.banner}
                        autoplay={true}
                        muted={true}
                        playBtn={false}
                      />
                    ...
                    <View style={{ margin: 13, borderRadius: 15 }}>
                      <View style={{ flexDirection: 'row' }}>
                        <View style={{ flex: 1, paddingLeft: 10 }}>
                          <Text style={[styles.text, themeTextColor]}>
                            Applied on:
                          </Text>
                          <Text style={[styles.text, themeTextColor]}>
                            Target date:
